...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false); // Hide loading state#00102e
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg border border-gray-200">
        <h2 className="text-2xl font-bold text-center text-[#00102e]">Welcome Back</h2>
        ...
        <form className="mt-6">
          ...
          <div className="text-center text-sm mt-4">
            ...
            <p className="text-gray-600 mt-2">
              Don't have an account? <Link to ="/signup" className="text-[] hover:underline">Sign up</Link>
            </p>
          </div>
        </form>
      </div>
