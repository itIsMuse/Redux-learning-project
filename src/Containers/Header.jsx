...
const Header = () => {
        ...
        <div className="flex gap-4">
          <div className="relative" ref={loginRef}>
            <button
              ...
              className="hover:text-[#084f70] flex items-center focus:outline-none"
            >
              <FaUser className="mr-1 hover:bg-[#084f70]" /> Login / Sign Up
            </button>
  ...
  <img src="logoswimingly.png" alt="Sale" className="w-35 h-12" />
        ...
        <div className="hidden md:flex gap-6">
          <Link to="/profile" className="hover:text-[#084f70]">
            <FaUser className="text-xl" />
          </Link>
          <Link to="/cart" className="hover:text-[#084f70] flex items-center">
        ...
        {menuOpen && (
          ...
          >
            <nav className="flex flex-col py-4 px-6 space-y-4">
              <Link to="/signup" className="flex items-center text-gray-700 hover:text-[#084f70]">
                <FaUser className="mr-2" /> Login / Sign Up
              </Link>
              <Link to="/help" className="flex items-center text-gray-700 hover:text-[#084f70]">
                <FaQuestionCircle className="mr-2" /> Help
              </Link>
              <Link to="/cart" className="flex items-center text-gray-700 hover:text-[#084f70]">
